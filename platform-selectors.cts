import type { CompanySourceType, PlatformSelectors } from "./contracts.cjs";

const defaultSelectors: PlatformSelectors = {
...
export const PLATFORM_SELECTORS: Partial<Record<CompanySourceType, PlatformSelectors>> = {
  workday: {
...
export function getSelectorsForSource(sourceType: CompanySourceType): PlatformSelectors {
  return PLATFORM_SELECTORS[sourceType] ?? defaultSelectors;
}
