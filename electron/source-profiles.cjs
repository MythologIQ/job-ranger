...
exports.sourceProfiles = void 0;
exports.getSourceProfile = getSourceProfile;
exports.canRunSourceType = canRunSourceType;
exports.sourceProfiles = {
    greenhouse: {
        type: "greenhouse",
        label: "Greenhouse",
        extractionMode: "api",
...
function getSourceProfile(type) {
    return exports.sourceProfiles[type] ?? exports.sourceProfiles.unsupported;
}
function canRunSourceType(type) {
